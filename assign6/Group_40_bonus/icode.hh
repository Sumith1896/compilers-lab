...
// class Array_Addr_Opd:public Ics_Opd
// {
// 	Symbol_Table_Entry * symbol_entry;
// 	int offset;

// public:
// 	Array_Addr_Opd(Symbol_Table_Entry & se, int off);
// 	~Array_Addr_Opd() {}

// 	void print_ics_opd(ostream & file_buffer);
// 	void print_asm_opd(ostream & file_buffer);

// 	Array_Addr_Opd & operator= (const Array_Addr_Opd & rhs);
// };
...
class Parameter_Store_Stmt: public Icode_Stmt
{ 
	Ics_Opd * opd1;   
	Ics_Opd * result; 
	int offset;
...
public:
	Parameter_Store_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, Ics_Opd * result, int off); 
	~Parameter_Store_Stmt() {} 
	Parameter_Store_Stmt & operator=(const Parameter_Store_Stmt & rhs);
