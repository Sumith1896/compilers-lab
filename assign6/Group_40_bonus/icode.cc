...
// /****************************** Class Array_Addr_Opd *****************************/

// Array_Addr_Opd::Array_Addr_Opd(Symbol_Table_Entry & se, int off) 
// {
// 	//TODO
// 	symbol_entry = &se;
// 	offset = off
...
// Array_Addr_Opd & Array_Addr_Opd::operator=(const Array_Addr_Opd & rhs)
// {
// 	//TODO
// 	symbol_entry = rhs.symbol_entry;
// 	offset = rhs.offset;
...
// void Array_Addr_Opd::print_ics_opd(ostream & file_buffer) 
// {
// 	//TODO
// 	file_buffer << symbol_entry->get_variable_name();
// }

// void Array_Addr_Opd::print_asm_opd(ostream & file_buffer) 
// {
// 	Table_Scope symbol_scope = symbol_entry->get_symbol_scope();
...
// 	if (symbol_scope == local || symbol_scope == formal)
// 	{
// 		int x_offset = symbol_entry->get_start_offset();
...
/*************************** Class Parameter_Store_Stmt *****************************/

Parameter_Store_Stmt::Parameter_Store_Stmt(Tgt_Op op, Ics_Opd * o1, Ics_Opd * res, int off)
{
	CHECK_INVARIANT((machine_desc_object.spim_instruction_table[op] != NULL),
			"Instruction description in spim table cannot be null");
...
Ics_Opd * Parameter_Store_Stmt::get_opd1()          { return opd1; }
Ics_Opd * Parameter_Store_Stmt::get_result()        { return result; }

void Parameter_Store_Stmt::set_opd1(Ics_Opd * io)   { opd1 = io; }
void Parameter_Store_Stmt::set_result(Ics_Opd * io) { result = io; }

Parameter_Store_Stmt& Parameter_Store_Stmt::operator=(const Parameter_Store_Stmt& rhs)
{
	op_desc = rhs.op_desc;
	opd1 = rhs.opd1;
	result = rhs.result; 
...
void Parameter_Store_Stmt::print_icode(ostream & file_buffer)
{
	CHECK_INVARIANT (opd1, "Opd1 cannot be NULL for a move IC Stmt");
	CHECK_INVARIANT (result, "Result cannot be NULL for a move IC Stmt");
...
void Parameter_Store_Stmt::print_assembly(ostream & file_buffer)
{
	CHECK_INVARIANT (opd1, "Opd1 cannot be NULL for a move IC Stmt");
	CHECK_INVARIANT (result, "Result cannot be NULL for a move IC Stmt");
	string op_name = op_desc.get_mnemonic();
