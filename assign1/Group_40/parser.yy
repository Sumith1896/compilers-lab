...
|
	...
	//ADD YOUR CODE HERE
	{
		...
		CHECK_INVARIANT((stmt_list != NULL), "Statement List cannot be NULL");
		CHECK_INVARIANT((ass_ast != NULL), "Assignment Statement cannot be NULL");
		stmt_list->ast_push_back(ass_ast);
		$$ = stmt_list;
	}
...
assignment_statement:
	...
	if (NOT_ONLY_PARSE)
	{
		...
		Ast* lhs = $1;
		Ast* rhs = $3;
		Ast* ass_ast = new Assignment_Ast(lhs, rhs, get_line_number());
		$$ = ass_ast;
	}
	}
|
